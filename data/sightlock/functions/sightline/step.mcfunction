...
# Beam effect
execute as @a[dx=0,tag=!targeting] positioned ~-0.99 ~-0.99 ~-0.99 if entity @s[dx=0] as @p[tag=targeting,tag=!targeting] at @s anchored eyes run function sightlock:sightline/locked_on
